...
const MapSuicide = () => {
    React.useEffect(() => {
        ...
        //console.log(data);
            ...
            const color = d3.scaleQuantize([7,25], d3.schemeBlues[6])

            data = Object.assign(new Map(data.map((d) => [d.state_full_name, +d.death_rate,+d.death_num])));
            data.title = "Suicide Rate (%)";


            const svg = d3.select("#Mapchart2")
    ...
    return (
        <>
            <svg id="Mapchart2"></svg>
        </>
    )
}

export default MapSuicide;